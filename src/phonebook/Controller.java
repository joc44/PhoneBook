...
public class Controller implements Initializable {
    ...
    private void addContact(ActionEvent event) {
        ...
        if (email.length() > 3 && email.contains("@") && email.contains(".")) {
            Person newPerson = new Person(inputLastname.getText(), inputFirstName.getText(), email,Phone.getText());
            data.add(newPerson);
    ...
    public void setTableData() {
        ...
        TableColumn phoneCol = new TableColumn("Telefon szám");
        ...
        table.getColumns().addAll(lastNameCol, firstNameCol, emailCol,phoneCol, removeCol);
